...
const UomStockRepository = require('../../repositories/stocking_uom');
const Transformer = require('../../transformers/stocking-uoms/list');
...
exports.getUomStock = async function (data, context) {
    ...
    const result = await UomStockRepository.findAndCountAll(wheres, offset, limit);
