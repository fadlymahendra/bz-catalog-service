...
const Transformer = require('../../transformers/mails/premoderation_approved');

exports.postEmailPremoderationApproved = async function (data, context) {
    const days = new Date();
    const getDays = Helper.rangeDate(days.getDay());

    const wheres = {};
    wheres.premoderation_status = 'done';
    wheres.created_at = {
