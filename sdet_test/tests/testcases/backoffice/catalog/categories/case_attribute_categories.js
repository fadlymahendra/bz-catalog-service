...
const getAttribute = {
  ...
  correctparam_datacontent: {
    description: 'As a content team, I can see attribute category in correct param and correct data content',
    responseCode: global.response.ok,
  },
  correctdata: {
    description: 'As a content team, I can see attribute category in correct data for : ',
    responseCode: global.response.ok,
  },
